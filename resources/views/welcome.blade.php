...
// // $sid = getenv("AC334f5f814595f7035159ab683bb5fc98");
// // $token = getenv("4112f5077f4d14fcd5ff31cd7d588599");
...
// $verificationCheck = $client->messages->create(
...
//         'body' => "Phone verification functionality has been completed. Now working on Laravel Blade Template."
//         //Phone verification functionality has been completed. Now working on Laravel Blade Template.
//     ]
// );
        ...
        >
            ...
            >
                <div class="md:flex w-full">
                    <div
                        class="hidden md:block w-1/2 bg-rose-500 py-10 px-10"
                    >
                        <svg
                    ...
                    <form class="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input
                                            ...
                                            name="name"
                                            type="text"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-rose-500"
                                            placeholder="John"
                                        />
                                    </div>
                                </div>
                ...
                //   if ($verificationCheck) {
                    if(1) {
                    echo '<span class="text-green-500">Code send successfully!</span>';
                  } 
                  else {
                    echo '<span class="text-rose-500">Invalid phone number. Please try again.</span>';
                  }
                  ?> -->
                                </div>
                            </div>
